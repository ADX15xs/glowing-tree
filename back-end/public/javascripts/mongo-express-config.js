...
module.exports = {
  mongodb: {
    ...
    auth: [
       ...
       */
      {
        database: process.env.ME_CONFIG_MONGODB_AUTH_DATABASE || 'flag_app_db',
  ...
  site: {
    ...
    port:             process.env.VCAP_APP_PORT                 || 3031,
  ...
  basicAuth: {
    ...
    password: process.env.ME_CONFIG_BASICAUTH_PASSWORD || 'root',
  },
